Pod::Spec.new do |s|
  ...
  s.dependency 'KissXML', :git => 'https://github.com/imbee-me/KissXML.git', :branch => 'feature/xcode15'
  s.dependency 'libidn', :git => 'https://github.com/imbee-me/libidn-framework.git', :branch => 'feature/xcode15'
end
